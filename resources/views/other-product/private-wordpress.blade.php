...
<title>Private Wordpress Hosting-PDN Cloud</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="page-title">Private Wordpress Hosting</div>
                    <div id="page-icon">
...
<div id="h-info" class="container-fluid">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="info-text grey-text">Performance Wordpress Plan</div>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
                ...
                <div class="pricing-box pricing-box-simple pricing-color1">
                    <div class="pricing-content">
                        <div class="pricing-head">
                            <div class="pricing-title">Private Wordpress 1</div>
                            ...
                            <div class="pricing-options">
                                ...
                                <div class="tab-content">
                                    <div id="monthly1" class="tab-pane fade in active">
                                        <div class="pricing-price">45000 MMK</div>
                                        <div class="billing-cycle">per month</div>
                                    </div>
                                    <div id="annualy1" class="tab-pane fade">
                                        <div class="pricing-price">540000 MMK</div>
                        ...
                        <div class="pricing-details">
                            ...
                            <li>99% Uptime</li>
                            <li>Daily Backup</li>
                            <li>Best For Medium Traffic CMS Websites</li>
                        ...
                        <div class="pricing-link">
                            <a class="ybtn" href="https://portal.pdncloud.com/cart.php?a=add&pid=19">Buy Now</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-md-4">
                <div class="pricing-box pricing-box-simple pricing-color2 bestbuy">
                    <div class="pricing-content">
                        <div class="pricing-head">
                            <div class="pricing-title">Private Wordpress 2</div>
                            <div class="pricing-features">
                                <ul>
                                    <!-- <li>Great for Starting Website</li>
                                    <li>Small Websites</li>
                            ...
                            <div class="pricing-options">
                                ...
                                <div class="tab-content">
                                    <div id="monthly2" class="tab-pane fade in active">
                                        <div class="pricing-price">70000 MMK</div>
                                        <div class="billing-cycle">per month</div>
                                    </div>
                                    <div id="annualy2" class="tab-pane fade">
                                        <div class="pricing-price">840000 MMK</div>
                                        <div class="billing-cycle">per year</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="pricing-link">
                            <a class="ybtn" href="https://portal.pdncloud.com/cart.php?a=add&pid=20">Buy Now</a>
                        </div>
                    </div>
                </div>
            </div>
