...
<title>Shared Wordpress Hosting-PDN Cloud</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="page-title">IPTV Reseller</div>
                    <div id="page-icon">
...
<div id="h-info" class="container-fluid">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="info-text grey-text">Best IPTV for Android TV, Android Box, Phone, Laptop, PC, Smart TV(LG/Samsung)</div>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
                ...
                <div class="pricing-box pricing-box-simple pricing-color1">
                    <div class="pricing-content">
                        <div class="pricing-head">
                            <div class="pricing-title">50 Months</div>
                            ...
                            <div class="pricing-options">
                                ...
                                <div class="tab-content">
                                    <div id="monthly1" class="tab-pane fade in active">
                                        <div class="pricing-price">125000 MMK</div>
                                        <div class="billing-cycle">per 50 Months</div>
                                    </div>
                                    <!-- <div id="annualy1" class="tab-pane fade">
                                        <div class="pricing-price">160000 MMK</div>
                        ...
                        <div class="pricing-details">
                            <ul>
                            <li>2500/Month</li>
                            <li>Stable Streams</li>
                            <li>Buffer Free</li>
                            <li>Daily Movie/Series Updates</li>
                        ...
                        <div class="pricing-link">
                            <a class="ybtn" href="https://portal.pdncloud.com/cart.php?a=add&pid=1">Buy Now</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-md-4">
                <div class="pricing-box pricing-box-simple pricing-color2 bestbuy">
                    <div class="pricing-content">
                        <div class="pricing-head">
                            <div class="pricing-title">100 Months Plan</div>
                            <div class="pricing-features">
                                <ul>
                                    <!-- <li>Great for Starting Website</li>
                                    <li>Small Websites</li>
                            ...
                            <div class="pricing-options">
                                ...
                                <div class="tab-content">
                                    <div id="monthly2" class="tab-pane fade in active">
                                        <div class="pricing-price">240000 MMK</div>
                                        <div class="billing-cycle">per 100 Months</div>
                                    </div>
                                    <!-- <div id="annualy2" class="tab-pane fade">
                                        <div class="pricing-price">320000 MMK</div>
                                        <div class="billing-cycle">per year</div>
                                    </div> -->
                                </div>
                            </div>
                        ...
                        <div class="pricing-link">
                            <a class="ybtn" href="https://portal.pdncloud.com/cart.php?a=add&pid=2">Buy Now</a>
                        </div>
                    </div>
                </div>
            </div>
