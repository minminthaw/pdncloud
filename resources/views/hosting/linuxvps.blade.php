...
<title>Linux VPS Hosting-PDN Cloud</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="page-title">Linux VPS Hosting</div>
                    <div id="page-icon">
                ...
                <div class="pricing-box pricing-box-simple pricing-color1">
                    <div class="pricing-content">
                        <div class="pricing-head">
                            <div class="pricing-title">Linux VPS 2</div>
                            ...
                            <div class="pricing-options">
                                ...
                                <div class="tab-content">
                                    <div id="monthly1" class="tab-pane fade in active">
                                        <div class="pricing-price">30000 MMK</div>
                                        <div class="billing-cycle">per month</div>
                                    </div>
                                    <div id="annualy1" class="tab-pane fade">
                                        <div class="pricing-price">360000 MMK</div>
                        ...
                        <div class="pricing-details">
                            ...
                            <li><strong>RAM:</strong> 2048 MB</li>
                            <li><strong>Storage:</strong> 20 GB</li>
                            <li><strong>Bandwidth:</strong> 4 TB</li>
                            <li><strong>Backups:</strong> Optional</li>
                        ...
                        <div class="pricing-link">
                            <a class="ybtn" href="https://portal.pdncloud.com/cart.php?a=add&pid=81">Buy Now</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-md-4">
                <div class="pricing-box pricing-box-simple pricing-color2 bestbuy">
                    <div class="pricing-content">
                            ...
                            <div class="pricing-options">
                                ...
                                <div class="tab-content">
                                    <div id="monthly2" class="tab-pane fade in active">
                                        <div class="pricing-price">54000 MMK</div>
                                        <div class="billing-cycle">per month</div>
                                    </div>
                                    <div id="annualy2" class="tab-pane fade">
                                        <div class="pricing-price">644000 MMK</div>
                                        <div class="billing-cycle">per year</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="pricing-link">
                            <a class="ybtn" href="https://portal.pdncloud.com/cart.php?a=add&pid=102">Buy Now</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-12 col-md-4">
                <div class="pricing-box pricing-box-simple pricing-color3">
                    <div class="pricing-content">
                            ...
                            <div class="pricing-options">
                                ...
                                <div class="tab-content">
                                    <div id="monthly3" class="tab-pane fade in active">
                                        <div class="pricing-price">74000 MMK</div>
                                        <div class="billing-cycle">per month</div>
                                    </div>
                                    <div id="annualy3" class="tab-pane fade">
                                        <div class="pricing-price">870000 MMK</div>
                                        <div class="billing-cycle">per year</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="pricing-details">
                            <ul>
                            <li><strong>CPU:</strong> 3 vCPU</li>
                        ...
                        <div class="pricing-link">
                            <a class="ybtn" href="https://portal.pdncloud.com/cart.php?a=add&pid=105">Buy Now</a>
                        </div>
                    </div>
                </div>
            </div>
