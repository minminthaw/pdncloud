...
<title>Window VPS Hosting-PDN Cloud</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="page-title">Window VPS Hosting</div>
                    <div id="page-icon">
        ...
        <div class="row">
                ...
                <div class="pricing-box pricing-box-simple pricing-color1">
                    <div class="pricing-content">
                        <div class="pricing-head">
                            <div class="pricing-title">Window 4</div>
                            ...
                            <div class="pricing-options">
                                ...
                                <div class="tab-content">
                                    <div id="monthly1" class="tab-pane fade in active">
                                        <div class="pricing-price">88000 MMK</div>
                        ...
                        <div class="pricing-details">
                            ...
                            <li><strong>Available OS:</strong> Windows 2012 / 2016 / 2019</li>
                        ...
                        <div class="pricing-link">
                            <a class="ybtn" href="https://portal.pdncloud.com/cart.php?a=add&pid=110">Buy Now</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-md-4">
                <div class="pricing-box pricing-box-simple pricing-color2 bestbuy">
                    <div class="pricing-content">
                        <div class="pricing-head">
                            <div class="pricing-title">Window 16</div>
                            <div class="pricing-features">
                                <ul>
                                    <li>Great for Intermediate</li>
                                    </ul>
                            </div>
                            <div class="pricing-options">
                                <ul class="nav nav-tabs">
                                ...
                                <div class="tab-content">
                                    <div id="monthly2" class="tab-pane fade in active">
                                        <div class="pricing-price">220000 MMK</div>
                                        <div class="billing-cycle">per month</div>
                                    </div>
                        ...
                        <div class="pricing-details">
                            ...
                            <li><strong>Storage:</strong> 160 GB</li>
                            <li><strong>Bandwidth:</strong> 32 TB</li>
                            <li><strong>Available OS:</strong> Windows 2012 / 2016 / 2019</li>
                                <!-- <li class="not-included">Support 24/7</li>
                                <li class="not-included">Linux server</li> -->
                            </ul>
                        ...
                        <div class="pricing-link">
                            <a class="ybtn" href="https://portal.pdncloud.com/cart.php?a=add&pid=106">Buy Now</a>
                        </div>
                    </div>
                </div>
            </div>
