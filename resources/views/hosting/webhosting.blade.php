...
<title>Web Hosting-PDN Cloud</title>
                ...
                <div class="pricing-box pricing-box-simple pricing-color1">
                    <div class="pricing-content">
                            ...
                            <div class="pricing-options">
                                ...
                                <div class="tab-content">
                                    <div id="monthly1" class="tab-pane fade in active">
                                        <div class="pricing-price">20000 MMK</div>
                                        <div class="billing-cycle">per month</div>
                                    </div>
                                    <div id="annualy1" class="tab-pane fade">
                                        <div class="pricing-price">118000 MMK</div>
                        ...
                        <div class="pricing-link">
                            <a class="ybtn" href="https://portal.pdncloud.com/store/shared-hosting">Create New Account</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="pricing-options">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="annualy2" class="tab-pane fade">
                                        <div class="pricing-price">350000 MMK</div>
                                        <div class="billing-cycle">per year</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="pricing-options">
                                ...
                                <div class="tab-content">
                                    <div id="monthly3" class="tab-pane fade in active">
                                        <div class="pricing-price">50000 MMK</div>
                                        <div class="billing-cycle">per month</div>
                                    </div>
                                    <div id="annualy3" class="tab-pane fade">
                                        <div class="pricing-price">750000 MMK</div>
                                        <div class="billing-cycle">per year</div>
                                    </div>
                                </div>
                            </div>
